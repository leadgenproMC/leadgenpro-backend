...
Write-Host ""
Write-Host "Si el backend está caído, verifica:" -ForegroundColor Yellow
Write-Host "1. El despliegue en Railway está activo" -ForegroundColor White
Write-Host "2. Las variables de entorno están configuradas" -ForegroundColor White
